...
const (
	TasksGenNum             = 50   // Кол-во задач которые будут сгенерированы
	...
	SuccessFunctionsPercent = 90   // Кол-во фиктивных функций с успешным результатом выполнения (остальные с ошибками)
)

func main() {
	tasks := genTasks(TasksGenNum)
